...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                sub_dist = X[i] - self.X_train[j]
                dists[i][j] = np.dot(sub_dist, sub_dist) ** 0.5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            sub_dist = self.X_train - X[i]
            dists[i] = np.sum(sub_dist ** 2, axis=1) ** 0.5
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = (-2 * np.dot(X, self.X_train.T) + np.sum(self.X_train ** 2, axis=1) + 
                 np.sum(X ** 2, axis=1, keepdims=True)) ** 0.5
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
